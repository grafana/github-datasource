...
export const ToggleInputField = (props: ToggleInputFieldProps) => {
  ...
  return (
    <ToggleField
      ...
      <Input css='' disabled={inputDisabled} value={filters && filters[key]} width={RightColumnWidth} onChange={el => {
        props.onChange({
          ...options,
          filters: {
            ...filters,
  ...
  return (
    <>
      <QueryInlineField labelWidth={LeftColumnWidth} label="Labels" tooltip="Selecting two or more labels will search for issues that have ALL labels, not either">
        <LabelSelector width={RightColumnWidth * 2 + LeftColumnWidth} options={labelOptions || []} value={labels} onChange={onLabelsChange} />
      </QueryInlineField>
      <QueryEditorRow>
  ...
  return (
    <>
      <QueryInlineField labelWidth={LeftColumnWidth} label="Query" tooltip="For more information, visit https://docs.github.com/en/github/searching-for-information-on-github/searching-issues-and-pull-requests">
        <Input css='' value={props.query} width={RightColumnWidth * 2 + LeftColumnWidth} onChange={el => props.onChange({
          ...props,
