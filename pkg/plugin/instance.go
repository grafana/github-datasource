...
func (i *Instance) HandleRepositoriesQuery(ctx context.Context, q *models.RepositoriesQuery, req backend.DataQuery) (github.Repositories, error) {
	return i.Datasource.HandleRepositoriesQuery(ctx, q, req)
}

// HandleIssuesQuery ...
func (i *Instance) HandleIssuesQuery(ctx context.Context, q *models.IssuesQuery, req backend.DataQuery) (github.Issues, error) {
	return i.Datasource.HandleIssuesQuery(ctx, q, req)
}

// HandleCommitsQuery ...
func (i *Instance) HandleCommitsQuery(ctx context.Context, q *models.CommitsQuery, req backend.DataQuery) (github.Commits, error) {
	return i.Datasource.HandleCommitsQuery(ctx, q, req)
}

// HandleTagsQuery ...
func (i *Instance) HandleTagsQuery(ctx context.Context, q *models.TagsQuery, req backend.DataQuery) (github.Tags, error) {
	return i.Datasource.HandleTagsQuery(ctx, q, req)
}

// HandleReleasesQuery ...
func (i *Instance) HandleReleasesQuery(ctx context.Context, q *models.ReleasesQuery, req backend.DataQuery) (github.Releases, error) {
	return i.Datasource.HandleReleasesQuery(ctx, q, req)
}

// HandleContributorsQuery ...
func (i *Instance) HandleContributorsQuery(ctx context.Context, q *models.ContributorsQuery, req backend.DataQuery) (github.Users, error) {
	return i.Datasource.HandleContributorsQuery(ctx, q, req)
}

// HandlePullRequestsQuery ...
func (i *Instance) HandlePullRequestsQuery(ctx context.Context, q *models.PullRequestsQuery, req backend.DataQuery) (github.PullRequests, error) {
	return i.Datasource.HandlePullRequestsQuery(ctx, q, req)
}

// HandleLabelsQuery ...
func (i *Instance) HandleLabelsQuery(ctx context.Context, q *models.LabelsQuery, req backend.DataQuery) (github.Labels, error) {
	return i.Datasource.HandleLabelsQuery(ctx, q, req)
}

// HandlePackagesQuery ...
func (i *Instance) HandlePackagesQuery(ctx context.Context, q *models.PackagesQuery, req backend.DataQuery) (github.Packages, error) {
	return i.Datasource.HandlePackagesQuery(ctx, q, req)
}

// HandleMilestonesQuery ...
func (i *Instance) HandleMilestonesQuery(ctx context.Context, q *models.MilestonesQuery, req backend.DataQuery) (github.Milestones, error) {
