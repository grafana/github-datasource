...
// ListCopilotMetricsOptions defines the options for listing Copilot metrics for an organization
...
// ListCopilotMetricsTeamOptions defines the options for listing Copilot metrics for a team
type ListCopilotMetricsTeamOptions struct {
	Organization string     `json:"organization"`
...
// CopilotMetricsTeamOptionsWithOrg adds the Owner value to a ListCopilotMetricsTeamOptions. This is a convenience function because this is a common operation
func CopilotMetricsTeamOptionsWithOrg(opt ListCopilotMetricsTeamOptions, owner string) ListCopilotMetricsTeamOptions {
	return ListCopilotMetricsTeamOptions{
		Organization: owner,
